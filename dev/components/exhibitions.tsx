  ...
  return (
    <section>
        ...
        {!!currentExhibitions[0] && (
          <>
            ...
            currentExhibitions.length === 1 ? (
              <ExhibitionPrieview
                heading={locale === "cy" ? "Arddangosfa gyfredol" : "Current exhibition"}
                exhibition={currentExhibitions[0]}
              />
            ) : (
              <>
                <ExhibitionPrieview
                  heading={locale === "cy" ? "Arddangosfeydd cyfredol" : "Current exhibitions"}
                  exhibition={currentExhibitions[0]}
                />
                <ExhibitionPrieview
                  heading={" "}
      ...
      <div className="sidebarContainer" style={{ marginTop: `6rem` }}>
        <div className="portableContainer">
          <p>{locale === "cy" ? "Arddangosfeydd y gorffennol" : "Past exhibitions"}</p>
        </div>
      </div>
