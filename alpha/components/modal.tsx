...
export const Modal: FC<Props> = ({
  ...
  // } as CSSProperties
  return (
    <div className={`${s.modalContainer} ${modal ? s.hideModal : null}`}>
      <div className={`${s.btnPrev}`} onClick={prevIndex}>
        <img
          alt="Previous"
      ...
      <div className={`${s.btnNext}`} onClick={nextIndex}>
        <img
          alt="Next"
      ...
      <div className={`${s.handleClose}`} onClick={closeModal}></div>
      <div className={`${s.modalClose}`} onClick={closeModal}>
        <img
          alt="Close lightbox"
      ...
      <div className={`${s.modalImageContiner}`}>
